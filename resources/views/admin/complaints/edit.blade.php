        ...
        <form method="POST" action="{{ route('admin.complaints.update', $complaint) }}">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label class="block text-gray-700 font-semibold mb-2">Ditugaskan Ke</label>
                    <select name="assigned_to" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent">
                ...
                <!-- Admin Response -->
                <div class="md:col-span-2">
                    <label class="block text-gray-700 font-semibold mb-2">Respon Admin</label>
                    <textarea name="admin_response" rows="5" 
                        ...
                        placeholder="Berikan respon untuk keluhan ini...">{{ old('admin_response', $complaint->admin_response) }}</textarea>
